...
const ContactSection = () => {
  ...
  return (
    <section id="contact" className="py-32 teal-gradient-bg">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
          <div>
            <motion.p {...fadeInUp} className="label-caps text-primary mb-4 text-3xl">تواصل</motion.p>
          ...
          <motion.form {...fadeInUp} transition={withDelay(0.2)} onSubmit={handleSubmit} className="space-y-6">
            {[
              ...
              <div key={field.name}>
                ...
                <input
                  ...
                  className="w-full bg-transparent border-b border-foreground/20 py-3 text-foreground focus:border-primary focus:outline-none transition-colors duration-300"
                  required
                />
              </div>
            ))}
            <div>
              ...
              <textarea
                ...
                rows={4}
                className="w-full bg-transparent border-b border-foreground/20 py-3 text-foreground focus:border-primary focus:outline-none transition-colors duration-300 resize-none"
                required
              />
            </div>
            <button
